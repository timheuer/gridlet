...
- **Active-game exclusion**: `PuzzleWarmupService` excludes words from currently saved daily/unlimited puzzles when warming the next unlimited puzzle so a background game does not reuse words from the game the user is already playing.
